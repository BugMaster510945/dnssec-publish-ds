...
// InjectedVersion is injected by the linker at build time.
var InjectedVersion string

// Copier-coller du code de github.com/carlmjohnson/versioninfo car debian n'as pas packagé la dépendance
var (
...
// Short returns the version string, preferring InjectedVersion if set,
// then module tag, then VCS revision from build info.
func Short() string {
	if InjectedVersion != "" {
